...
function buildVolumeMounts(
  ...
  if (fs.existsSync(envFile)) {
    ...
    const allowedVars = ['CLAUDE_CODE_OAUTH_TOKEN', 'ANTHROPIC_API_KEY', 'SLACK_WEBHOOK_URL', 'POSTEO_USER', 'POSTEO_PASSWORD', 'POSTEO_IMAP_HOST', 'POSTEO_SMTP_HOST', 'CODEBERG_API_KEY', 'ELEVENLABS_API_KEY', 'MATRIX_ACCESS_TOKEN', 'MATRIX_HOMESERVER', 'MATRIX_USER_ID', 'MATRIX_DEVICE_ID', 'DISCOURSE_URL', 'DISCOURSE_API_KEY', 'DISCOURSE_DEFAULT_USERNAME', 'DISCOURSE_BOT_USERNAMES', 'LOB_PROD_API_SECRET_KEY', 'LOB_TEST_API_SECRET_KEY', 'LOB_PROD_API_PUBLISHABLE_KEY', 'LOB_TEST_API_PUBLISHABLE_KEY'];
